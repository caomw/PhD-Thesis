...
public class TreeDemo extends JPanel implements TreeSelectionListener {
	...
	private void createNodes(DefaultMutableTreeNode top) {
		DefaultMutableTreeNode exampleNodes = null;
		DefaultMutableTreeNode book = null;

		exampleNodes = new DefaultMutableTreeNode("ImageSci Examples");
		top.add(exampleNodes);
		...
		exampleNodes = new DefaultMutableTreeNode("Books for Java Implementers");
		top.add(exampleNodes);
